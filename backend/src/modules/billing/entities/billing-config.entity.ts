...
export class BillingConfigEntity {
  ...
  @Column({ name: 'gcash_qr_code_url', nullable: true }) gcashQrCodeUrl: string;
  @Column({ name: 'gcash_account_name', nullable: true }) gcashAccountName: string;
  @Column({ name: 'gcash_number', nullable: true }) gcashNumber: string;
